...
with open('task2_WCC_PAGERANK_OUTPUT.txt', 'a') as f:
    for key, value in pagerank_wcc.items():
        f.write('%s:%s\n' % (key, value))

with open('task2_SCC_PAGERANK_OUTPUT.txt', 'a') as f:
    for key, value in pagerank_scc.items():
        f.write('%s:%s\n' % (key, value))
'''
...
with open('task3_RANDOM_PAGERANK_OUTPUT.txt', 'a') as f:
    for key, value in pagerank_random.items():
        f.write('%s:%s\n' % (key, value))

with open('task3_BA_PAGERANK_OUTPUT.txt', 'a') as f:
    for key, value in pagerank_ba.items():
        f.write('%s:%s\n' % (key, value))
